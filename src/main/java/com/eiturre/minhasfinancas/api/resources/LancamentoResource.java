...
import com.eiturre.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.eiturre.minhasfinancas.api.dto.LancamentoDTO;
...
import com.eiturre.minhasfinancas.model.enums.TipoLancamento;
	...
	public ResponseEntity atualizarStatus( @PathVariable("id") Long id, @RequestBody AtualizaStatusDTO dto) {
		return service.obterPorId(id).map (entity -> {
			...
			if(statusSelecionado == null) {
				return ResponseEntity.badRequest().body("Não foi possível atualizar do lançamento, envie um Status válido.");
			}
			try {
